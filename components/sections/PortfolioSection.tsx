...
export default function PortfolioSection() {
  ...
  const categories = [
    { id: 'all', label: 'Todos' },
    { id: 'infraestructura', label: 'Soporte IT' },
  ...
  const projects = [
    {
      ...
      description: 'Instalación completa de rack de servidores y cableado estructurado',
    ...
    },
    {
      ...
      description: 'ERP personalizado para empresa manufacturera en Rosario',
    ...
    },
    {
      ...
      description: 'Métricas en tiempo real para dirección y C-Level',
      image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&q=80',
    },
    {
      id: 4,
      category: 'infraestructura',
      title: 'Red Corporativa Estructurada',
      description: 'Cableado Cat6A y switching para 80 puestos de trabajo',
    ...
    },
    {
      ...
      description: 'Scripts Python para automatización de reportes y tareas repetitivas',
    ...
    },
    {
      ...
      description: 'Streamlit dashboard para análisis de ventas e inventario',
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop&q=80',
    },
    {
      id: 7,
      category: 'consultoria',
      title: 'Diagnóstico IT Integral',
      description: 'Auditoría tecnológica completa y plan de modernización',
    ...
    },
    {
      ...
      description: 'Migración de infraestructura on-premise a Microsoft Azure',
    ...
    },
    {
      ...
      description: 'Estrategia de digitalización para empresa distribuidora',
